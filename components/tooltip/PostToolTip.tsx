...
const PostToolTip: React.FunctionComponent = (props) => {
    ...
    const {postTooltipX, postTooltipY, postTooltipEnabled, postTooltipID} = useInteractionSelector()
    const {setEnableDrag, setPostTooltipEnabled} = useInteractionActions()
    ...
    useEffect(() => {
        if (postTooltipID) updatePost()
    }, [postTooltipID, session])
    ...
    const getStyle = () => {
        return {
            width: "420px",
            height: "250px",
            opacity: postTooltipEnabled ? "1" : "0", 
            pointerEvents: postTooltipEnabled ? "all" : "none",
            left: `${postTooltipX}px`, 
            top: `${postTooltipY}px`
    ...
    return (
        <div className="tooltip" style={getStyle()} onMouseEnter={() => setPostTooltipEnabled(true)} onMouseLeave={() => setPostTooltipEnabled(false)}>
            ...
            <div className="tooltip-column" ref={scrollRef} style={{overflowY: "auto", flexDirection: "row"}}>
                    <div className="tooltip-column-container">
                        <img className="tooltip-image" src={img} fetchPriority="high" draggable={false}/>
                    </div>
                    <div className="tooltip-column-container">
