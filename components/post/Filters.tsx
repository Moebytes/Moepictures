...
const Filters: React.FunctionComponent<Props> = (props) => {
    ...
    const imageFiltersJSX = () => {
        return (
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={brightnessIcon} style={{filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={contrastIcon} style={{marginLeft: "7px", marginRight: "-7px", filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={hueIcon} style={{marginLeft: "20px", marginRight: "-20px", filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={saturationIcon} style={{filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={lightnessIcon} style={{filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={blurIcon} style={{marginLeft: "20px", marginRight: "-20px", filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={sharpenIcon} style={{marginLeft: "8px", marginRight: "-8px", filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={pixelateIcon} style={{filter}}/>
            ...
            {session.showR18 ? 
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={splatterIcon} style={{filter}}/>
    ...
    const musicFiltersJSX = () => {
        return (
            <>
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={lowpassIcon} style={{filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={highpassIcon} style={{filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={reverbIcon} style={{filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={delayIcon} style={{filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={phaserIcon} style={{filter}}/>
            ...
            <div className="filter-dropdown-row filter-row">
                <img className="filter-dropdown-img" src={bitcrushIcon} style={{filter}}/>
