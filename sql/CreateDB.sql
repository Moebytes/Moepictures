...
CREATE TABLE IF NOT EXISTS "users" (
    ...
    "accountToken" uuid UNIQUE NOT NULL,
    "joinDate" date,
...
CREATE TABLE IF NOT EXISTS "tag map" (
    ...
    "postID" bigint REFERENCES "posts" ("postID") ON UPDATE CASCADE ON DELETE CASCADE,
    "tagID" bigint REFERENCES "tags" ("tagID") ON UPDATE CASCADE ON DELETE CASCADE,
    UNIQUE ("postID", "tagID")
);
...
CREATE TABLE IF NOT EXISTS "blocked tags" (
    "tagID" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "tag" text UNIQUE NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "subscription events" (
    "eventID" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "messageID" text UNIQUE,
    "subscriptionKey" text REFERENCES "subscriptions" ("subscriptionKey") ON UPDATE CASCADE ON DELETE CASCADE,
    "platform" text,
    "event" text,
