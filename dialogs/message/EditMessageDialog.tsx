                ...
                <div className="dialog-box" ref={dialogRef} onMouseEnter={() => setEnableDrag(false)} onMouseLeave={() => setEnableDrag(true)}>
                    <div className="dialog-container">
                        ...
                        <div className="dialog-textarea-buttons">
                            <button className="dialog-textarea-button"><img src={highlight} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "highlight")} style={{filter}}/></button>
                            <button className="dialog-textarea-button"><img src={bold} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "bold")} style={{filter}}/></button>
                            <button className="dialog-textarea-button"><img src={italic} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "italic")} style={{filter}}/></button>
                            <button className="dialog-textarea-button"><img src={underline} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "underline")} style={{filter}}/></button>
                            <button className="dialog-textarea-button"><img src={strikethrough} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "strikethrough")} style={{filter}}/></button>
                            <button className="dialog-textarea-button"><img src={spoiler} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "spoiler")} style={{filter}}/></button>
                            <button className="dialog-textarea-button"><img src={link} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "link")} style={{filter}}/></button>
                            <button className="dialog-textarea-button"><img src={details} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "details")} style={{filter}}/></button>
                            <button className="dialog-textarea-button"><img src={hexcolor} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "color")} style={{filter}}/></button>
                            <button className="dialog-textarea-button"><img src={codeblock} onClick={() => functions.render.triggerTextboxButton(textRef.current, setEditMessageContent, "code")} style={{filter}}/></button>
                        </div>
                        ...
                        {session.showR18 ?
                        <div className="dialog-row">
                            <img className="dialog-checkbox" src={editMessageR18 ? radioButtonChecked : radioButton} onClick={() => setEditMessageR18(!editMessageR18)} style={{marginLeft: "0px", filter}}/>
