            ...
            <div className="dialog">
                ...
                className="dialog-box" ref={dialogRef} onMouseEnter={() => setEnableDrag(false)} onMouseLeave={() => setEnableDrag(true)}>
                    <div className="dialog-container">
                        ...
                        <div className="dialog-row">
                            {editMessageR18 ?
                            <RadioButtonCheckedIcon className="dialog-checkbox" onClick={() => setEditMessageR18(!editMessageR18)} style={{marginLeft: "0px"}}/> :
                            <RadioButtonIcon className="dialog-checkbox" onClick={() => setEditMessageR18(!editMessageR18)} style={{marginLeft: "0px"}}/>}
